...
public class ScheduleConstants {
	...
	public static final String FLIGHT_CANCELLED="CANCELLED";
	public static final String CANCELLED_SUCCESSFULLY= "SCHEDULE CANCELLED SUCCESSFULLY FOR THE SCHEDULE ";
